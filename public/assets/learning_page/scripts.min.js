...
(function ($) {
  ...
  function handleFileHtml(file) {
    if (file.online_viewer && file.online_viewer !== '0' || file.downloadable && file.downloadable !== '0') {
      if (file.online_viewer && file.online_viewer !== '0') {
        ...
        if (file.is_video) {
          var $html = "<div class=\"js-video-and-download flex flex-col p-4 h-full\">";
      ...
      switch (file.storage) {
        ...
        case 'external_link':
        case 's3':
          var _$html = $('<div class="learning-content-video-player w-full"></div>');
        ...
        case 'secure_host':
          var $secureHosthtml = $('<div class="learning-content-video-player w-full"></div>');
  ...
  function handleContentBoxHtml(title, hint, img) {
    ...
    return "<div class=\"flex items-center justify-center w-full h-full\">\n                    <div class=\"learning-content-box flex align-center justify-center flex-col p-4 lg:p-8 rounded-lg\">\n                        <div class=\"learning-content-box-icon text-center\">\n                            <img src=\"/assets/default/img/learning/".concat(img, "\" alt=\"downloadable icon\">\n                        </div>\n\n                        <h4 class=\"font-16 font-semibold ").concat(titleClassName !== null && titleClassName !== void 0 ? titleClassName : '', "\">").concat(title, "</h4>\n\n                        <span class=\"font-14 font-weight-500 mt-5\">").concat(hint, "</span>\n\n                        ").concat(html !== null && html !== void 0 ? html : '', "\n                    </div>\n                </div>");
  }

  function addContentLoading() {
    var html = "<div class=\"learning-content-loading d-flex align-items-center justify-content-center flex-column w-full h-full\">\n            <img src=\"/assets/default/img/loading.gif\" alt=\"\">\n            <p class=\"mt-10\">".concat(pleaseWaitForTheContentLang, "</p>\n        </div>");
    learningPageContent.html(html);
  }
...
module.exports = __webpack_require__(/*! /home/jack/projects/webinar/resources/js/parts/learningPage/scripts.js */"./resources/js/parts/learningPage/scripts.js");
