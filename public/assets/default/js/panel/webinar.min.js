    ...
    $('body').on('click', '.js-add-course-content-btn, .add-new-interactive-file-btn', function (e) {
        ...
        switch (type) {
            case 'file':
                ...
                initializeUploadVideoDropzone(`uploadVideo${key}`,`uploadButton${key}`,`videoFile${key}`);
                $(`#collapseFile${key} .js-file-path-input`).hide();

                $(`#collapseFile${key} .js-file-storage`).on('change',function() {

                    var selectedSource = $(this).val();
    
                    $(`#collapseFile${key} .uploadVideo${key}`).hide();
                    $(`#collapseFile${key} .js-file-path-input`).hide();
    
                    if (selectedSource === 'upload') {
                        $(`#collapseFile${key} .uploadVideo${key}`).show();
                    } else {
                        $(`#collapseFile${key} .js-file-path-input`).show();
                    }
                });
