...
class AssignmentController extends Controller
{
    public function myAssignments(Request $request)
    {
        ...
        return view('web.jiujitsu.panel.assignments.my-assignments', $data);
    }
    ...
    public function myCoursesAssignments(Request $request)
    {
        ...
        return view('web.jiujitsu.panel.assignments.my-courses-assignments', $data);
    }
    ...
    public function students(Request $request, $id)
    {
        ...
        if (!empty($assignment)) {
            ...
            return view('web.jiujitsu.panel.assignments.students', $data);
        }
