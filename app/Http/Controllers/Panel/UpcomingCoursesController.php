...
class UpcomingCoursesController extends Controller
{
    ...
    public function followers($id)
    {
        ...
        if (!empty($upcomingCourse)) {
            ...
            return view('web.jiujitsu.panel.upcoming_courses.followers', $data);
        }
    ...
    public function assignCourseModal($id)
    {
        ...
        if (!empty($upcomingCourse)) {
            ...
            $html = (string)view()->make('web.jiujitsu.panel.upcoming_courses.assign_course_modal', $data);
    ...
    public function followings()
    {
        ...
        return view('web.jiujitsu.panel.upcoming_courses.followings', $data);
    }
}
