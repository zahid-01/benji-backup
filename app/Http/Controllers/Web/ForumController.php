...
class ForumController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('web.jiujitsu.forum.index', $data);
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('web.jiujitsu.forum.topics_search', $data);
    }
    ...
    public function topics(Request $request, $slug)
    {
        ...
        if (!empty($forum)) {
            ...
            return view('web.jiujitsu.forum.topics', $data);
        }
    ...
    public function createTopic(Request $request)
    {
        ...
        return view('web.jiujitsu.forum.create_topic', $data);
    }
    ...
    public function posts($forumSlug, $topicSlug)
    {
        ...
        if (!empty($forum) and $forum->checkUserCanCreateTopic()) {
            ...
            if (!empty($topic)) {
                ...
                return view('web.jiujitsu.forum.posts', $data);
            }
        }
