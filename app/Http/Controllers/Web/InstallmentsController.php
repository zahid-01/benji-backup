...
class InstallmentsController extends Controller
{
        ...
        if (!empty($itemId) and !empty($itemType) and getInstallmentsSettings('status')) {
            ...
            if (!empty($item)) {
                ...
                if (!empty($installment)) {
                    ...
                    return view('web.jiujitsu.installment.verify', $data);
                }
            }
        }
    ...
    public function requestSubmitted()
    {
        ...
        return view('web.jiujitsu.installment.request_submitted', $data);
    }
    ...
    public function requestRejected()
    {
        ...
        return view('web.jiujitsu.installment.request_rejected', $data);
    }
}
