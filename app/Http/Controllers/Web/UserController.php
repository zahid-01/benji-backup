...
class UserController extends Controller
{
    ...
    public function profile($id)
    {
        ...
        return view('web.jiujitsu.user.profile', $data);
    }
    ...
    public function instructors(Request $request)
    {
        ...
        return view('web.jiujitsu.pages.instructors', $data);
    }
    ...
    public function handleInstructorsOrOrganizationsPage(Request $request, $role)
    {
        ...
        if ($request->ajax()) {
            ...
            foreach ($instructors as $instructor) {
                ...
                $html .= (string)view()->make('web.jiujitsu.pages.instructor_card', ['instructor' => $instructor]);
                $html .= '</div>';
            }
