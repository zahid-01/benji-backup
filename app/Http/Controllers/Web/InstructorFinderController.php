...
class InstructorFinderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('web.jiujitsu.instructorFinder.index', $data);
    }
    ...
    private function handleLoadMoreHtml($instructors)
    {
        ...
        foreach ($instructors as $instructor) {
            $html .= (string)view()->make('web.jiujitsu.instructorFinder.components.instructor_card', ['instructor' => $instructor]);
        }
    ...
    public function wizard(Request $request)
    {
        ...
        return view('web.jiujitsu.instructorFinder.wizard', $data);
    }
}
