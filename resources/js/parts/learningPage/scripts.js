(function ($) {
        ...
        if ((file.online_viewer && file.online_viewer !== '0') || (file.downloadable && file.downloadable !== '0')) {
            ...
            if ((file.online_viewer && file.online_viewer !== '0')) {
                ...
                if ((file.downloadable && file.downloadable !== '0')) {
                    html += `<div class="flex items-center justify-between rounded-sm mt-4">
                ...
                if (file.is_video) {
                    let $html = `<div class="js-video-and-download flex flex-col p-3 h-full">`;

                    $html += '<div class="learning-content-video-player w-full"></div>';
            ...
            switch (file.storage) {
                ...
                case 's3':
                    ...
                    const $html = $('<div class="learning-content-video-player w-full"></div>');
                ...
                case 'secure_host':
                    ...
                    const $secureHosthtml = $('<div class="learning-content-video-player w-full"></div>');
    ...
    function handleContentBoxHtml(title, hint, img, html = null, titleClassName = null) {
        return `<div class="flex items-center justify-center w-full h-full">
                    <div class="learning-content-box flex items-center justify-center flex-col p-4 lg:p-8 rounded-lg">
    ...
    function addContentLoading() {
        const html = `<div class="learning-content-loading d-flex align-items-center justify-content-center flex-column w-full h-full">
