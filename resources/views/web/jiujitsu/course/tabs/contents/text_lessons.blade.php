...
<div class="accordion-row rounded-sm border mt-15 p-15">
    <div class="flex items-center justify-between" role="tab" id="textLessons_{{ $textLesson->id }}">
        <div class="flex items-center" href="#collapseTextLessons{{ $textLesson->id }}" aria-controls="collapseTextLessons{{ $textLesson->id }}" data-parent="#{{ $accordionParent }}" role="button" data-toggle="collapse" aria-expanded="true">
            ...
            <span class="font-bold text-black text-sm file-title ml-3"> {{ $textLesson->title }}</span>
        </div>
        ...
        <div class="panel-collapse">
            ...
            @if(!empty($user) and $hasBought)
                <div class="flex items-center mt-4">
                    <label class="mb-0 mr-10 cursor-pointer font-medium" for="textLessonReadToggle{{ $textLesson->id }}">{{ trans('public.i_passed_this_lesson') }}</label>
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex items-center text-slate-500 text-center text-sm mr-20">
                        <i data-feather="paperclip" width="18" height="18" class="text-slate-500 mr-5"></i>
