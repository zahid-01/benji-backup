...
<div class="max-h-20 overflow-hidden relative" id="additionalContent">
    {{-- Installments --}}
    @if (
    ...
    <div class="bg-gradient-to-t from-white to-blue-500 z-20 absolute bottom-0 left-0 h-full w-full" id="gradient">
        &nbsp;
    </div>
</div>
    ...
    <script>
        $(document).ready(function() {
            $("#showMoreBtn").click(function() {
                $("#additionalContent").toggleClass("max-h-20");
                $("#gradient").toggleClass("bg-gradient-to-t");
                if ($("#additionalContent").hasClass("max-h-20")) {
