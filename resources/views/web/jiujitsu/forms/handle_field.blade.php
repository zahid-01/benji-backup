            ...
            <div class="form-group">
                ...
                @foreach($field->options as $option)
                    <div class="custom-control custom-checkbox mt-10">
                        ...
                        <label class="custom-control-label text-sm" for="checkbox{{ $option->id }}">{{ $option->title }}</label>
                    </div>
                @endforeach
            ...
            <div class="form-group">
                ...
                @foreach($field->options as $option)
                    <div class="custom-control custom-radio mt-10">
                        ...
                        <label class="custom-control-label text-sm" for="radio{{ $option->id }}">{{ $option->title }}</label>
                    </div>
                @endforeach
