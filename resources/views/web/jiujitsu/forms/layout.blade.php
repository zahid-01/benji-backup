...
@section('content')
    <div class="forms-hero relative" @if(!empty($form->cover)) style="background-image: url('{{ $form->cover }}')" @endif>
        <div class="forms-hero-mask"></div>

        <div class="forms-hero-content container user-select-none relative">
