            ...
            <div class="row h-100 items-center justify-center text-center">
                <div class="col-12 col-md-9 col-lg-7">
                    <div class="top-search-categories-form">
                        <h1 class="text-white text-3xl mb-15">{{ !empty($category) ? $category->title : $pageTitle }}</h1>
    ...
    <div class="container mt-6">
        ...
        @if(!empty($featureWebinars) and !$featureWebinars->isEmpty())
            <section class="mb-25 mb-lg-0">
                ...
                <span class="text-sm text-slate-500 font-weight-400">{{ trans('site.newest_courses_subtitle') }}</span>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            @foreach($featureWebinars as $featureWebinar)
                                <div class="swiper-slide">
                                    @include('web.jiujitsu.includes.webinar.grid-card',['webinar' => $featureWebinar->webinar])
                                </div>
                            @endforeach
        ...
        <section class="mt-lg-50 pt-lg-20 mt-md-40 pt-md-40">
            <form action="{{ $sortFormAction }}" method="get" id="filtersForm">
                ...
                @include('web.jiujitsu.pages.includes.top_filters')
                            ...
                            <div class="row">
                                @foreach($webinars as $webinar)
                                    <div class="col-12 col-lg-6 mt-4">
                                        @include('web.jiujitsu.includes.webinar.grid-card',['webinar' => $webinar])
                                    </div>
                                @endforeach
                            </div>
