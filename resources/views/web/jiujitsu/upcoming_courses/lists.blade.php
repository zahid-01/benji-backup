            ...
            <div class="row h-100 items-center justify-center text-center">
                <div class="col-12 col-md-9 col-lg-7">
                    <div class="top-search-categories-form">
                        <h1 class="text-white text-3xl mb-15">{{ trans('update.upcoming_courses') }}</h1>
    ...
    <div class="container mt-6">
        ...
        <section class="mt-lg-50 pt-lg-20 mt-md-40 pt-md-40">
            <form action="/upcoming_courses" method="get" id="filtersForm">
                ...
                @include('web.jiujitsu.upcoming_courses.includes.top_filters')
                ...
                <div class="row mt-4">
                    <div class="col-12 col-lg-8">
                            ...
                            <div class="row">
                                @foreach($upcomingCourses as $upcomingCourse)
                                    <div class="col-12 col-lg-6 mt-4">
                                        @include('web.jiujitsu.includes.webinar.upcoming_course_grid_card',['upcomingCourse' => $upcomingCourse])
                                    </div>
                                @endforeach
                            </div>
                        ...
                        @elseif(!empty(request()->get('card')) and request()->get('card') == 'list')
                            ...
                            @foreach($upcomingCourses as $upcomingCourse)
                                @include('web.jiujitsu.includes.webinar.upcoming_course_list_card',['upcomingCourse' => $upcomingCourse])
                            @endforeach
                        @endif
                    ...
                    <div class="col-12 col-lg-4">
                        @include('web.jiujitsu.upcoming_courses.includes.right_filters')
                    </div>
                </div>
