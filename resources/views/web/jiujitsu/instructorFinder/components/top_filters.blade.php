<div id="topFilters" class="mt-25 shadow-lg border border-gray300 rounded-sm p-10 p-md-20">
    <div class="row items-center">
        <div class="col-lg-9 block d-mflex items-center justify-content-start my-25 my-lg-0">
            ...
            <div class="flex items-center justify-between justify-content-md-center mx-0 mx-md-20 my-20 my-md-0">
