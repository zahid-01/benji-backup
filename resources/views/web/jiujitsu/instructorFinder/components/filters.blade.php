<div class="mt-4 p-20 rounded-sm shadow-lg border border-gray300 filters-container">
    <h3 class="category-filter-title font-20 font-bold text-dark-blue">{{ trans('update.filters') }}</h3>
    ...
    <div class="form-group">
        ...
        <div class="flex items-center wizard-custom-radio mt-5">
            <div class="wizard-custom-radio-item grow">
                ...
                <label class="text-sm cursor-pointer px-15 py-10" for="all">{{ trans('public.all') }}</label>
            </div>

            <div class="wizard-custom-radio-item grow">
                <input type="radio" name="meeting_type" value="in_person" id="in_person" class="" {{ (request()->get('meeting_type') == 'in_person') ? 'checked' : '' }}>
                <label class="text-sm cursor-pointer px-15 py-10" for="in_person">{{ trans('update.in_person') }}</label>
            </div>

            <div class="wizard-custom-radio-item grow">
                <input type="radio" name="meeting_type" value="online" id="online" class="" {{ (request()->get('meeting_type') == 'online') ? 'checked' : '' }}>
                <label class="text-sm cursor-pointer px-15 py-10" for="online">{{ trans('update.online') }}</label>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="flex items-center wizard-custom-radio mt-5">
            <div class="wizard-custom-radio-item grow">
                ...
                <label class="text-sm cursor-pointer px-15 py-10" for="population_all">{{ trans('public.all') }}</label>
            </div>

            <div class="wizard-custom-radio-item grow">
                <input type="radio" name="population" value="single" id="population_single" class="" {{ (request()->get('population') == 'single') ? 'checked' : '' }}>
                <label class="text-sm cursor-pointer px-15 py-10" for="population_single">{{ trans('update.single') }}</label>
            </div>

            <div class="wizard-custom-radio-item grow">
                <input type="radio" name="population" value="group" id="population_group" class="" {{ (request()->get('population') == 'group') ? 'checked' : '' }}>
                <label class="text-sm cursor-pointer px-15 py-10" for="population_group">{{ trans('update.group') }}</label>
            </div>
        </div>
    </div>
