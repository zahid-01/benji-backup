<section>
    <h3 class="section-title after-line mt-8">{{ trans('site.about') }}</h3>
    ...
    <div class="row mt-4">
        <div class="col-12 col-lg-6">
            ...
            <div class="form-group">
                ...
                <div class="mt-15">
                     <p class="text-sm text-slate-500">- {{ trans('panel.bio_hint_1') }}</p>
                     <p class="text-sm text-slate-500">- {{ trans('panel.bio_hint_2') }}</p>
                </div>
