...
<section class="mt-6">
    ...
    @if(!$user->isUser())
        ...
        <div class="row mt-4">
            <div class="col-12 col-lg-4">
                ...
                <div class="form-group mb-30 mt-6">
                    ...
                    <div class="flex items-center">
                        <div class="custom-control custom-radio">
                            ...
                            <label class="custom-control-label text-sm cursor-pointer" for="man">{{ trans('update.man') }}</label>
                        </div>
                        ...
                        <div class="custom-control custom-radio ml-15">
                            ...
                            <label class="custom-control-label text-sm cursor-pointer" for="woman">{{ trans('update.woman') }}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group mb-30">
                    ...
                    <div class="flex items-center">
                        <div class="custom-control custom-radio">
                            ...
                            <label class="custom-control-label text-sm cursor-pointer" for="in_person">{{ trans('update.in_person') }}</label>
                        </div>
                        ...
                        <div class="custom-control custom-radio ml-10">
                            ...
                            <label class="custom-control-label text-sm cursor-pointer" for="online">{{ trans('update.online') }}</label>
                        </div>
                        ...
                        <div class="custom-control custom-radio ml-10">
                            ...
                            <label class="custom-control-label text-sm cursor-pointer" for="all">{{ trans('public.all') }}</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group mb-30">
                    ...
                    <div class="flex items-center">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label text-sm cursor-pointer" for="beginner">{{ trans('update.beginner') }}</label>
                        </div>
                        ...
                        <div class="custom-control custom-checkbox ml-10">
                            ...
                            <label class="custom-control-label text-sm cursor-pointer" for="middle">{{ trans('update.middle') }}</label>
                        </div>
                        ...
                        <div class="custom-control custom-checkbox ml-10">
                            ...
                            <label class="custom-control-label text-sm cursor-pointer" for="expert">{{ trans('update.expert') }}</label>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-lg-8">
                <div class="form-group">
                    ...
                    <div id="mapContainer" class="hidden">
                        ...
                        <span class="block text-sm text-slate-500">{{ trans('update.select_location_hint') }}</span>
    ...
    @if(!empty($formFieldsHtml))
        <h2 class="section-title after-line mt-6">{{ trans('update.forms') }}</h2>
