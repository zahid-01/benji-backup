    ...
    <div class="row mt-4">
        <div class="col-12 col-lg-4">
            ...
            <div class="form-group">
                ...
                <p class="text-sm text-slate-500 mt-5"><a href="https://developers.zoom.us/docs/internal-apps/create/#steps-to-create-a-server-to-server-oauth-app">{{ trans('update.zoom_api_key_hint') }}</a></p>
            </div>
            ...
            <div class="form-group">
                ...
                <p class="text-sm text-slate-500 mt-5"><a href="https://developers.zoom.us/docs/internal-apps/create/#steps-to-create-a-server-to-server-oauth-app">{{ trans('update.zoom_api_secret_hint') }}</a></p>
            </div>
            ...
            <div class="form-group">
                ...
                <p class="text-sm text-slate-500 mt-5"><a href="https://developers.zoom.us/docs/internal-apps/create/#steps-to-create-a-server-to-server-oauth-app">{{ trans('update.zoom_account_id_hint') }}</a></p>
            </div>
