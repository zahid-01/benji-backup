            ...
            <div class="row">
                ...
                <div class="col-4 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ $referredUsersCount }}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('panel.referred_users') }}</span>
                    </div>
                </div>
                ...
                <div class="col-4 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ handlePrice($registrationBonus) }}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('panel.registration_bonus') }}</span>
                    </div>
                </div>
                ...
                <div class="col-4 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ handlePrice($affiliateBonus) }}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('panel.affiliate_bonus') }}</span>
                    </div>
                </div>
    ...
    <section class="mt-25">
        ...
        <div class="row mt-15">
            <div class="col-12 col-lg-5">
                <h3 class="font-16 font-medium">{{ trans('panel.affiliate_url') }}</h3>
                                ...
                                <tr>
                                    <td class="text-left">
                                        <div class="user-inline-avatar flex items-center">
                                            ...
                                            <div class=" ml-2">
                                                <span class="block font-medium">{{ $affiliate->referredUser->full_name }}</span>
                                            </div>
                                        </div>
                                    </td>
