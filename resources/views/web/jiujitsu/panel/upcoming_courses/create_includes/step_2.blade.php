...
<div class="row">
    <div class="col-12 col-md-6 mt-15">
        ...
        <div class="form-group">
            ...
            @enderror
            <p class="text-slate-500 mt-5 text-sm">{{  trans('update.upcoming_sections_hint')  }}</p>
        </div>
        ...
        <div class="form-group">
            ...
            @enderror
            <p class="text-slate-500 mt-5 text-sm">{{  trans('update.upcoming_parts_hint')  }}</p>
        </div>
        ...
        <div class="form-group">
            ...
            @enderror
            <p class="text-slate-500 mt-5 text-sm">{{  trans('update.upcoming_progress_hint')  }}</p>
        </div>
        ...
        <div>
            <p class="text-sm text-slate-500">{{ trans('update.upcoming_certificate_hint') }}</p>
        </div>
...
<div class="form-group mt-15 {{ (!empty($upcomingCourseCategoryFilters) and count($upcomingCourseCategoryFilters)) ? '' : 'hidden' }}" id="categoriesFiltersContainer">
