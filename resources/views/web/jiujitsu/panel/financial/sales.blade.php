            ...
            <div class="row">
                <div class="col-6 col-md-3 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl font-bold mt-5 text-dark-blue">{{ $studentCount }}</strong>
                        <span class="font-16 font-medium text-slate-500">{{ trans('quiz.students') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl font-bold mt-5 text-dark-blue">{{ $webinarCount }}</strong>
                        <span class="font-16 font-medium text-slate-500">{{ trans('panel.content_sales') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 flex items-center justify-center mt-5 mt-md-0">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl font-bold mt-5 text-dark-blue">{{ $meetingCount }}</strong>
                        <span class="font-16 font-medium text-slate-500">{{ trans('panel.appointment_sales') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 flex items-center justify-center mt-5 mt-md-0">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl font-bold mt-5 text-dark-blue">{{ handlePrice($totalSales) }}</strong>
                                    ...
                                    <tr>
                                        <td class="text-left">
                                            @if(!empty($sale->buyer))
                                                <div class="user-inline-avatar flex items-center">
                                                    ...
                                                    <div class=" ml-2">
                                                        <span class="block">{{ $sale->buyer->full_name }}</span>
                                                        <span class="mt-5 text-sm text-slate-500 block">{{ $sale->buyer->email }}</span>
                                                    </div>
                                                </div>
                                            @else
                                        ...
                                        <td class="align-middle">
                                            <div class="text-left">
                                                ...
                                                @if(!empty($contentId))
                                                    <span class="block text-sm text-slate-500">Id: {{ $contentId }}</span>
                                                @endif
                                            </div>
                                        </td>
                                        <td class="align-middle">
                                        ...
                                        <td class="align-middle">
                                            @switch($sale->type)
                                                ...
                                                <span class="text-black">{{ trans('update.registration_package') }}</span>
                                                @break;
