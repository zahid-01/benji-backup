...
<div class="row">
    <div class="col-12 col-md-6 mt-15">
        ...
        <div class="form-group js-inventory-inputs {{ (!empty($product) and $product->unlimited_inventory) ? 'hidden' : '' }}">
        ...
        <div class="form-group mt-6 mb-10 flex items-center">
        ...
        <p class="text-slate-500 text-sm">{{ trans('update.create_product_unlimited_inventory_hint') }}</p>
...
<div class="row">
    ...
    <div class="col-12 mt-4">
        <div class="form-group {{ (!empty($productCategoryFilters) and count($productCategoryFilters)) ? '' : 'hidden' }}" id="categoriesFiltersContainer">
