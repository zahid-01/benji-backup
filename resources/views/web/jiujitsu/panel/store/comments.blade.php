                                ...
                                @foreach($comments as $comment)
                                    <tr>
                                        ...
                                        <td class=" text-left align-middle" width="35%">
                                            <a href="{{ $comment->product->getUrl() }}" target="_blank" class="text-dark-blue font-medium">{{ $comment->product->title }}</a>
                                        </td>
                                        ...
                                        <td class="align-middle text-right">
                                            ...
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <button type="button" data-item-id="{{ $comment->product_id }}" data-comment-id="{{ $comment->id }}" class="btn-ghost webinar-actions block mt-10 text-hover-primary report-comment">{{ trans('panel.report') }}</button>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
