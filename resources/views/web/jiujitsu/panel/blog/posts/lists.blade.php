            ...
            <div class="row">
                <div class="col-4 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ $postsCount }}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('update.articles') }}</span>
                    </div>
                </div>
                ...
                <div class="col-4 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ $commentsCount }}</strong>
                ...
                <div class="col-4 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ $pendingPublishCount }}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('update.pending_publish') }}</span>
                    </div>
                </div>
                                        ...
                                        <td class="text-center align-middle">
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu font-weight-normal">
                                                    <a href="/panel/blog/posts/{{ $post->id }}/edit" class="webinar-actions block mt-10">{{ trans('public.edit') }}</a>
                                                    <a href="/panel/blog/posts/{{ $post->id }}/delete" data-item-id="1" class="webinar-actions block mt-10 delete-action">{{ trans('public.delete') }}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
