                                ...
                                @foreach($comments as $comment)
                                    <tr>
                                        ...
                                        <td class=" text-left align-middle" width="35%">
                                            <a href="{{ $comment->blog->getUrl() }}" target="_blank" class="text-dark-blue font-medium">{{ $comment->blog->title }}</a>
                                        </td>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            @else
                                                <span class="text-dark-blue font-medium">{{ trans('public.pending') }}</span>
                                            @endif
                                        </td>
