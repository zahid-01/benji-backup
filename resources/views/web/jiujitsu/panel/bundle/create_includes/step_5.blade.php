                ...
                @if(!empty($bundle->faqs) and count($bundle->faqs))
                    <ul class="draggable-lists" data-order-table="faqs">
                        @foreach($bundle->faqs as $faqInfo)
                            @include('web.jiujitsu.panel.bundle.create_includes.accordions.faq',['bundle' => $bundle,'faq' => $faqInfo])
                        @endforeach
                    </ul>
                @else
...
<div id="newFaqForm" class="hidden">
    @include('web.jiujitsu.panel.bundle.create_includes.accordions.faq',['bundle' => $bundle])
</div>
