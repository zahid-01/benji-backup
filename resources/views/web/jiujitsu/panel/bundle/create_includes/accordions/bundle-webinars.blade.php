<li data-id="{{ !empty($bundleWebinar) ? $bundleWebinar->id :'' }}" class="accordion-row bg-white rounded-sm panel-shadow mt-4 py-15 py-lg-30 px-10 px-lg-20">
    <div class="flex items-center justify-between " role="tab" id="bundleWebinar_{{ !empty($bundleWebinar) ? $bundleWebinar->id :'record' }}">
        <div class="font-bold text-dark-blue" href="#collapseBundleWebinar{{ !empty($bundleWebinar) ? $bundleWebinar->id :'record' }}" aria-controls="collapseBundleWebinar{{ !empty($bundleWebinar) ? $bundleWebinar->id :'record' }}" data-parent="#bundleWebinarsAccordion" role="button" data-toggle="collapse" aria-expanded="true">
            ...
            @if(!empty($bundleWebinar))
                <div class="btn-group dropdown table-actions mr-15">
                    ...
                    <div class="dropdown-menu">
                        <a href="/panel/bundle-webinars/{{ $bundleWebinar->id }}/delete" class="delete-action btn btn-sm btn-ghost">{{ trans('public.delete') }}</a>
                    </div>
                </div>
            @endif
                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <div class="form-group mt-15">
                            <label class="input-label block">{{ trans('panel.select_course') }}</label>
                        ...
                        <div class="mt-5">
                            <p class="text-sm text-slate-500">- {{ trans('update.bundle_webinars_required_hint') }}</p>
                        </div>
