            ...
            <div class="row">
                <div class="col-6 col-md-3 mt-6 mt-md-0 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ !empty($bundles) ? $bundlesCount : 0}}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('update.bundles') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 mt-6 mt-md-0 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ convertMinutesToHourAndMinute($bundlesHours) }}</strong>
                ...
                <div class="col-6 col-md-3 mt-6 mt-md-0 flex items-center justify-center mt-5 mt-md-0">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ handlePrice($bundleSalesAmount) }}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('update.bundle_sales') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 mt-6 mt-md-0 flex items-center justify-center mt-5 mt-md-0">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ $bundleSalesCount }}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('update.bundle_sales_count') }}</span>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="webinar-card-body w-full flex flex-col">
                                <div class="flex items-center justify-between">
                                    <a href="{{ $bundle->getUrl() }}" target="_blank">
                                        <h3 class="font-16 text-dark-blue font-bold">{{ $bundle->title }}</h3>
                                    </a>
                                    ...
                                    @if($authUser->id == $bundle->creator_id or $authUser->id == $bundle->teacher_id)
                                        <div class="btn-group dropdown table-actions">
                                            ...
                                            <div class="dropdown-menu ">
                                                ...
                                                <a href="/panel/bundles/{{ $bundle->id }}/edit" class="webinar-actions block mt-10">{{ trans('public.edit') }}</a>

                                                <a href="/panel/bundles/{{ $bundle->id }}/courses" class="webinar-actions block mt-10">{{ trans('product.courses') }}</a>


                                                @if($authUser->id == $bundle->teacher_id or $authUser->id == $bundle->creator_id)
                                                    <a href="/panel/bundles/{{ $bundle->id }}/export-students-list" class="webinar-actions block mt-10">{{ trans('public.export_list') }}</a>
                                                @endif

                                                @if($bundle->creator_id == $authUser->id)
                                                    <a href="/panel/bundles/{{ $bundle->id }}/delete" class="webinar-actions block mt-10 text-danger delete-action">{{ trans('public.delete') }}</a>
                                                @endif
                                            </div>
                                        </div>
                                    @endif
