    ...
    <form method="post" action="/panel/support/store">
        ...
        <section>
            ...
            <div class="mt-25 rounded-sm shadow py-20 px-10 px-lg-25 bg-white">
                ...
                <div class="form-group">
                    <label class="input-label block">{{ trans('public.type') }}</label>
                ...
                <div id="departmentInput" class="form-group @if(!$errors->has('department_id')) hidden @endif">
                ...
                <div id="courseInput" class="form-group @if(!$errors->has('webinar_id')) hidden @endif">
                    <label class="input-label block">{{ trans('product.course') }}</label>
                ...
                <div class="row">
                    <div class="col-12 col-lg-8 flex items-center">
                        <div class="form-group">
