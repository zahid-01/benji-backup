            ...
            <div class="row">
                <div class="col-6 col-md-3 mt-6 mt-md-0 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ !empty($webinars) ? $webinarsCount : 0}}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('panel.classes') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 mt-6 mt-md-0 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ convertMinutesToHourAndMinute($webinarHours) }}</strong>
                ...
                <div class="col-6 col-md-3 mt-6 mt-md-0 flex items-center justify-center mt-5 mt-md-0">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ handlePrice($webinarSalesAmount) }}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('cart.total') .' '. trans('panel.webinar_sales') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 mt-6 mt-md-0 flex items-center justify-center mt-5 mt-md-0">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ handlePrice($courseSalesAmount) }}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('cart.total') .' '.trans('panel.course_sales') }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex align-items-start align-items-md-center justify-between flex-col flex-md-row">
            ...
            <form action="" method="get">
                <div class="flex items-center flex-row-reverse flex-md-row justify-content-start justify-content-md-center mt-4 mt-md-0">
                    <label class="cursor-pointer mb-0 mr-10 font-medium text-sm text-slate-500" for="conductedSwitch">{{ trans('panel.only_not_conducted_webinars') }}</label>
