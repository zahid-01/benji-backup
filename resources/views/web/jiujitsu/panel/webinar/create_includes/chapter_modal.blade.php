<div id="chapterModalHtml" class="hidden">
    <div class="custom-modal-body">
        <h2 class="section-title after-line">{{ trans('public.new_chapter') }}</h2>

        <div class="js-content-form chapter-form mt-4" data-action="/panel/chapters/store">
            ...
            <div class="form-group mt-2 flex items-center justify-between js-switch-parent">
