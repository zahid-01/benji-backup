...
<div class="row">
    <div class="col-12 col-md-4 mt-15">
        ...
        <div class="form-group mt-15 ">
            <label class="input-label block">{{ trans('panel.course_type') }}</label>
        ...
        @if($isOrganization)
            <div class="form-group mt-15 ">
                <label class="input-label block">{{ trans('public.select_a_teacher') }}</label>
        ...
        <div class="form-group mt-25">
            ...
            <div class="">
                <label class="input-label text-sm">{{ trans('public.source') }}</label>
        ...
        <div class="form-group mt-0">
            <label class="input-label text-sm">{{ trans('update.path') }}</label>
            <div class="input-group js-video-demo-path-input">
                <div class="input-group-prepend">
                    <button type="button" class="js-video-demo-path-upload input-group-text text-white panel-file-manager {{ (empty($webinar) or empty($webinar->video_demo_source) or $webinar->video_demo_source == 'upload') ? '' : 'hidden' }}" data-input="demo_video" data-preview="holder">
                        <i data-feather="upload" width="18" height="18" class="text-white"></i>
                    </button>

                    <button type="button" class="js-video-demo-path-links rounded-left input-group-text input-group-text-rounded-left text-white {{ (empty($webinar) or empty($webinar->video_demo_source) or $webinar->video_demo_source == 'upload') ? 'hidden' : '' }}">
...
@if($isOrganization)
    <div class="row">
        <div class="col-6">
            ...
            <p class="text-slate-500 text-sm">{{ trans('webinars.create_private_course_hint') }}</p>
        </div>
    </div>
@endif
