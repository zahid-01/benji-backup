...
<div class="row">
    <div class="col-12 col-md-6 mt-15">
        ...
        <div class="form-group mt-15">
            ...
            @enderror
            <p class="text-slate-500 mt-5 text-sm">{{  trans('forms.empty_means_unlimited')  }}</p>
        </div>
        ...
        @if(!empty(getFeaturesSettings("course_forum_status")))
            ...
            <div>
                <p class="text-sm text-slate-500">- {{ trans('update.panel_course_forum_hint') }}</p>
            </div>
        @endif

        <div class="form-group mt-6 flex items-center justify-between">
        ...
        <div>
            <p class="text-sm text-slate-500">- {{ trans('update.certificate_completion_hint') }}</p>
        </div>
        ...
        <div id="partnerInstructorInput" class="form-group mt-15 {{ ((!empty($webinar) && $webinar->partner_instructor) or old('partner_instructor') == 'on') ? '' : 'hidden' }}">
            <label class="input-label block">{{ trans('public.select_a_partner_teacher') }}</label>
            ...
            <div class="text-slate-500 text-sm mt-1">{{ trans('admin/main.invited_instructor_hint') }}</div>
            @error('partners')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
...
<div class="form-group mt-15 {{ (!empty($webinarCategoryFilters) and count($webinarCategoryFilters)) ? '' : 'hidden' }}" id="categoriesFiltersContainer">
