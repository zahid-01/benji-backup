            ...
            <div class="row">
                <div class="col-4 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl font-bold mt-5">{{ $comments->count() }}</strong>
                ...
                <div class="col-4 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl font-bold mt-5">{{ $repliedCommentsCount }}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('panel.replied') }}</span>
                    </div>
                </div>
                ...
                <div class="col-4 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl font-bold mt-5">{{ ($comments->count() - $repliedCommentsCount) }}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('panel.not_replied') }}</span>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        <th class="text-left">
                                            <div class="user-inline-avatar flex items-center">
                                                ...
                                                <span class="user-name ml-2 text-dark-blue font-medium">{{ $comment->user->full_name }}</span>
                                            </div>
                                        </th>
                                        <td class=" text-left align-middle" width="35%">
                                            <a href="{{ $comment->webinar->getUrl() }}" target="_blank" class="text-dark-blue font-medium">{{ $comment->webinar->title }}</a>
                                        </td>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            @else
                                                <span class="text-dark-blue font-medium">{{ trans('panel.replied') }}</span>
                                            @endif
                                        </td>
                                        ...
                                        <td class="align-middle text-right">
                                            ...
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu">
                                                    <button type="button" data-comment-id="{{ $comment->id }}" class="js-reply-comment btn-ghost">{{ trans('panel.reply') }}</button>
                                                    <button type="button" data-item-id="{{ $comment->webinar_id }}" data-comment-id="{{ $comment->id }}" class="btn-ghost webinar-actions block mt-10 text-hover-primary report-comment">{{ trans('panel.report') }}</button>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
