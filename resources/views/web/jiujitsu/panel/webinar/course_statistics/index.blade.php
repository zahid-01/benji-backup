...
@section('content')
            ...
            <div class="row">
                <div class="col-6 col-md-3 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl font-bold mt-5">{{ $studentsCount }}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('public.students') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl font-bold mt-5">{{ $commentsCount }}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('panel.comments') }}</span>
                    </div>
                </div>

                <div class="col-6 col-md-3 mt-10 mt-md-0 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        <img src="/assets/default/img/activity/sales.svg" width="64" height="64" alt="">
                        <strong class="text-3xl font-bold mt-5">{{ $salesCount }}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('panel.sales') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 mt-10 mt-md-0 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl font-bold mt-5">{{ (!empty($salesAmount) and $salesAmount > 0) ? handlePrice($salesAmount) : 0 }}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('panel.sales_amount') }}</span>
                    </div>
                </div>
    ...
    <section class="course-statistic-stat-icons row">
        ...
        <div class="col-6 col-md-3 mt-4">
            <div class="dashboard-stats rounded-sm panel-shadow p-10 p-md-20 flex items-center">
                <div class="stat-icon stat-icon-chapters">
                    <img src="/assets/default/img/icons/course-statistics/1.svg" alt="">
                </div>
                <div class="flex flex-col ml-2 ml-md-15">
                    <span class="text-3xl text-black">{{ $chaptersCount }}</span>
                    <span class="font-16 text-slate-500 font-medium">{{ trans('public.chapters') }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-6 col-md-3 mt-4">
            <div class="dashboard-stats rounded-sm panel-shadow p-10 p-md-20 flex items-center">
                ...
                <div class="flex flex-col ml-2 ml-md-15">
                    <span class="text-3xl text-black">{{ $sessionsCount }}</span>
                    <span class="font-16 text-slate-500 font-medium">{{ trans('public.sessions') }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-6 col-md-3 mt-4">
            <div class="dashboard-stats rounded-sm panel-shadow p-10 p-md-20 flex items-center">
                ...
                <div class="flex flex-col ml-2 ml-md-15">
                    <span class="text-3xl text-black">{{ $pendingQuizzesCount }}</span>
                    <span class="font-16 text-slate-500 font-medium">{{ trans('update.pending_quizzes') }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-6 col-md-3 mt-4">
            <div class="dashboard-stats rounded-sm panel-shadow p-10 p-md-20 flex items-center">
                ...
                <div class="flex flex-col ml-2 ml-md-15">
                    <span class="text-3xl text-black">{{ $pendingAssignmentsCount }}</span>
                    <span class="font-16 text-slate-500 font-medium">{{ trans('update.pending_assignments') }}</span>
                </div>
            </div>
        </div>
            ...
            <div class="col-12 col-md-3 mt-4">
                <div class="course-statistic-cards-shadow py-20 px-15 py-md-30 px-md-20 rounded-sm bg-white">
                    <div class="flex items-center flex-col">
                        ...
                        <span class="text-3xl text-black mt-25 font-bold">{{ $courseRate }}</span>
                        @include('web.jiujitsu.includes.webinar.rate',['rate' => $courseRate, 'className' => 'mt-5', 'dontShowRate' => true, 'showRateStars' => true])
                    </div>

                    <div class="flex items-center justify-between mt-4 pt-30 border-top font-16 font-medium">
                        <span class="text-slate-500">{{ trans('update.total_rates') }}</span>
                        <span class="text-black">{{ $courseRateCount }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-3 mt-4">
                <div class="course-statistic-cards-shadow py-20 px-15 py-md-30 px-md-20 rounded-sm bg-white">
                    <div class="flex items-center flex-col">
                        ...
                        <span class="text-3xl text-black mt-25 font-bold">{{ $webinar->quizzes->count() }}</span>
                        <span class="mt-5 font-16 font-medium text-slate-500">{{ trans('quiz.quizzes') }}</span>
                    </div>

                    <div class="flex items-center justify-between mt-4 pt-30 border-top font-16 font-medium">
                        <span class="text-slate-500">{{ trans('quiz.average_grade') }}</span>
                        <span class="text-black">{{ $quizzesAverageGrade }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-3 mt-4">
                <div class="course-statistic-cards-shadow py-20 px-15 py-md-30 px-md-20 rounded-sm bg-white">
                    <div class="flex items-center flex-col">
                        ...
                        <span class="text-3xl text-black mt-25 font-bold">{{ $webinar->assignments->count() }}</span>
                        <span class="mt-5 font-16 font-medium text-slate-500">{{ trans('update.assignments') }}</span>
                    </div>

                    <div class="flex items-center justify-between mt-4 pt-30 border-top font-16 font-medium">
                        <span class="text-slate-500">{{ trans('quiz.average_grade') }}</span>
                        <span class="text-black">{{ $assignmentsAverageGrade }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 col-md-3 mt-4">
                <div class="course-statistic-cards-shadow py-20 px-15 py-md-30 px-md-20 rounded-sm bg-white">
                    <div class="flex items-center flex-col">
                        ...
                        <span class="text-3xl text-black mt-25 font-bold">{{ $courseForumsMessagesCount }}</span>
                        <span class="mt-5 font-16 font-medium text-slate-500">{{ trans('update.forum_messages') }}</span>
                    </div>

                    <div class="flex items-center justify-between mt-4 pt-30 border-top font-16 font-medium">
                        <span class="text-slate-500">{{ trans('update.forum_students') }}</span>
                        <span class="text-black">{{ $courseForumsStudentsCount }}</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="row">
            @include('web.jiujitsu.panel.webinar.course_statistics.includes.pie_charts',[
    ...
    <section>
        <div class="row">
            <div class="col-12 col-md-6 mt-4">
                <div class="course-statistic-cards-shadow monthly-sales-card pt-15 px-15 pb-25 rounded-sm bg-white">
                    <div class="flex items-center justify-between">
                        <h3 class="font-16 text-dark-blue font-bold">{{ trans('panel.monthly_sales') }}</h3>
            ...
            <div class="col-12 col-md-6 mt-4">
                <div class="course-statistic-cards-shadow monthly-sales-card pt-15 px-15 pb-25 rounded-sm bg-white">
                    <div class="flex items-center justify-between">
                        <h3 class="font-16 text-dark-blue font-bold">{{ trans('update.course_progress') }} (%)</h3>
                    </div>
                    ...
                    <div class="col-12 ">
                        <div class="table-responsive">
                            <table class="table custom-table text-center ">
                                <thead>
                                <tr>
                                    <th class="text-left text-slate-500">{{ trans('quiz.student') }}</th>
                                    <th class="text-center text-slate-500">{{ trans('update.progress') }}</th>
                                    <th class="text-center text-slate-500">{{ trans('update.passed_quizzes') }}</th>
                                    <th class="text-center text-slate-500">{{ trans('update.unsent_assignments') }}</th>
                                    <th class="text-center text-slate-500">{{ trans('update.pending_assignments') }}</th>
                                    <th class="text-center text-slate-500">{{ trans('panel.purchase_date') }}</th>
                                </tr>
                                </thead>
                                <tbody>
                                @php
                                        ...
                                        <td class="text-left">
                                            <div class="user-inline-avatar flex items-center">
                                                ...
                                                <div class=" ml-2">
                                                    ...
                                                    <span class="mt-5 block text-sm text-slate-500">{{ $user->email }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="align-middle">
                                            <span class="text-dark-blue font-medium">{{ $user->course_progress ?? 0 }}%</span>
                                        </td>
                                        <td class="align-middle">
                                            <span class="text-dark-blue font-medium">{{ $user->passed_quizzes ?? 0 }}</span>
                                        </td>
                                        <td class="align-middle">
                                            <span class="text-dark-blue font-medium">{{ $user->unsent_assignments ?? 0 }}</span>
                                        </td>
                                        <td class="align-middle">
                                            <span class="text-dark-blue font-medium">{{ $user->pending_assignments ?? 0 }}</span>
                                        </td>
                                        <td class="align-middle">
                                            @if(empty($user->id))
                                                <span class="text-warning">{{ trans('update.unregistered') }}</span>
                                            @else
                                                <span class="text-dark-blue font-medium">{{ dateTimeFormat($user->created_at,'j M Y | H:i') }}</span>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
