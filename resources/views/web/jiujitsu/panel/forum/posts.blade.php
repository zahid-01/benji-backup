                                        ...
                                        <td class="text-left align-middle">
                                            <div class="user-inline-avatar flex items-center">
                                                ...
                                                <a href="{{ $post->topic->getPostsUrl() }}" target="_blank" class="">
                                                    <div class=" ml-2">
                                                        <span class="block text-sm font-medium text-dark-blue">{{ $post->topic->title }}</span>
                                                        <span class="text-sm text-slate-500 mt-5">{{ trans('public.by') }} {{ $post->topic->creator->full_name }}</span>
                                                    </div>
                                                </a>
                                            </div>
                                        </td>
