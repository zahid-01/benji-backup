                        ...
                        <div class="table-responsive">
                            <table class="table text-center custom-table">
                                ...
                                @foreach($certificates as $certificate)
                                    <tr>
                                        <td class="text-left">
                                            <span class="block text-dark-blue font-medium">{{ $certificate->webinar->title }}</span>
                                        </td>
                                        ...
                                        <td class="align-middle">
                                            <span class="text-dark-blue font-medium">{{ dateTimeFormat($certificate->created_at, 'j M Y') }}</span>
                                        </td>
                                        <td class="align-middle font-weight-normal">
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a href="/panel/certificates/webinars/{{ $certificate->id }}/show" target="_blank" class="webinar-actions block">{{ trans('public.open') }}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
