...
@section('content')
            ...
            <div class="row">
                <div class="col-4 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl font-bold mt-5">{{ $openReserveCount }}</strong>
                        <span class="font-16 text-dark-blue text-slate-500 font-medium">{{ trans('panel.open_meetings') }}</span>
                    </div>
                </div>
                ...
                <div class="col-4 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl font-bold mt-5">{{ $totalReserveCount }}</strong>
                        <span class="font-16 text-dark-blue text-slate-500 font-medium">{{ trans('panel.total_meetings') }}</span>
                    </div>
                </div>
                ...
                <div class="col-4 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ $activeHoursCount }}</strong>
    ...
    <section class="mt-8">
        <div class="flex align-items-start align-items-md-center justify-between flex-col flex-md-row">
            ...
            <form action="/panel/meetings/reservation?{{ http_build_query(request()->all()) }}" class="flex items-center flex-row-reverse flex-md-row justify-content-start justify-content-md-center mt-4 mt-md-0">
                                    ...
                                    <tr>
                                        <td class="text-left">
                                            <div class="user-inline-avatar flex items-center">
                                                ...
                                                <div class=" ml-2">
                                                    <span class="block font-medium">{{ $ReserveMeeting->meeting->creator->full_name }}</span>
                                                    <span class="mt-5 text-sm text-slate-500 block">{{ $ReserveMeeting->meeting->creator->email }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="align-middle">
                                            @switch($ReserveMeeting->status)
                                                ...
                                                @case(\App\Models\ReserveMeeting::$open)
                                                    <span class="text-slate-500 font-medium">{{ trans('public.open') }}</span>
                                                    @break
                                                @case(\App\Models\ReserveMeeting::$finished)
                                                    <span class="font-medium text-primary">{{ trans('public.finished') }}</span>
                                                    @break
                                                @case(\App\Models\ReserveMeeting::$canceled)
                                                    <span class="text-danger font-medium">{{ trans('public.canceled') }}</span>
                                                    @break
                                            @endswitch
                                        </td>
                                                ...
                                                <div class="btn-group dropdown table-actions">
                                                    ...
                                                    <div class="dropdown-menu menu-lg">
                                                        ...
                                                        <a href="{{ $ReserveMeeting->addToCalendarLink() }}" target="_blank"
                                                           class="webinar-actions block mt-10 font-weight-normal">{{ trans('public.add_to_calendar') }}</a>

                                                        <button type="button"
                                                                data-user-id="{{ $ReserveMeeting->meeting->creator_id }}"
                                                                data-item-id="{{ $ReserveMeeting->id }}"
                                                                data-user-type="instructor"
                                                                class="contact-info btn-ghost webinar-actions block mt-10">{{ trans('panel.contact_instructor') }}</button>
