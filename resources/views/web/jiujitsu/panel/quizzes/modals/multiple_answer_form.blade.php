<div class="add-answer-card mt-25 {{ (empty($answer) or (!empty($loop) and $loop->iteration == 1)) ? 'main-answer-row' : '' }}">
    <button type="button" class="btn btn-sm bg-red-600 text-white rounded-full answer-remove {{ (!empty($answer) and !empty($loop) and $loop->iteration > 1) ? '' : 'hidden' }}">
    ...
    <div class="row mt-15 align-items-end">
        ...
        <div class="col-12 col-md-4">
            <div class="form-group mt-4 flex items-center justify-between js-switch-parent">
