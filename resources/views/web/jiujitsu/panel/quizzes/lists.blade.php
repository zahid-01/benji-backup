            ...
            <div class="row">
                <div class="col-4 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ $quizzesCount }}</strong>
                ...
                <div class="col-4 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ $questionsCount }}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('public.questions') }}</span>
                    </div>
                </div>
                ...
                <div class="col-4 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ $userCount }}</strong>
        ...
        <div class="flex align-items-start align-items-md-center justify-between flex-col flex-md-row">
            ...
            <form action="/panel/quizzes" method="get" class="">
                <div class="flex items-center flex-row-reverse flex-md-row justify-content-start justify-content-md-center mt-4 mt-md-0">
                    <label class="mb-0 mr-10 cursor-pointer text-slate-500 text-sm font-medium" for="activeQuizzesSwitch">{{ trans('quiz.show_only_active_quizzes') }}</label>
                        ...
                        <div class="table-responsive">
                            <table class="table text-center custom-table">
                                ...
                                @foreach($quizzes as $quiz)
                                    <tr>
                                        <td class="text-left">
                                            <span class="block">{{ $quiz->title }}</span>
                                        ...
                                        <td class="text-center align-middle">
                                            ...
                                            @if(($quiz->display_limited_questions and !empty($quiz->display_number_of_questions)))
                                                <span class="text-sm text-slate-500">({{ trans('public.active') }}: {{ $quiz->display_number_of_questions }})</span>
                                            @endif
                                        </td>
                                        ...
                                        <td class="text-center align-middle">
                                            <span class="block">{{ $quiz->quizResults->pluck('user_id')->count() }}</span>

                                            @if(!empty($quiz->userSuccessRate) and $quiz->userSuccessRate > 0)
                                                <span class="text-sm text-primary block">{{ $quiz->userSuccessRate }}% {{ trans('quiz.passed')  }}</span>
                                            @endif
                                        </td>
                                        ...
                                        <td class="text-center align-middle">
                                            <div class="btn-group dropdown table-actions">
                                                ...
                                                <div class="dropdown-menu font-weight-normal">
                                                    <a href="/panel/quizzes/{{ $quiz->id }}/edit" class="webinar-actions block mt-10">{{ trans('public.edit') }}</a>
                                                    <a href="/panel/quizzes/{{ $quiz->id }}/delete" data-item-id="1" class="webinar-actions block mt-10 delete-action">{{ trans('public.delete') }}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
