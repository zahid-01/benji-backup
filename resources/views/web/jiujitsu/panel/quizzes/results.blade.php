            ...
            <div class="row">
                <div class="col-6 col-md-3 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ $waitingCount }}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('quiz.need_to_review') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 flex items-center justify-center">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ $quizResultsCount }}</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('public.results') }}</span>
                    </div>
                </div>
                ...
                <div class="col-6 col-md-3 mt-6 mt-md-0 flex items-center justify-center mt-5 mt-md-0">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ $quizAvgGrad }}</strong>
                ...
                <div class="col-6 col-md-3 mt-6 mt-md-0 flex items-center justify-center mt-5 mt-md-0">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <strong class="text-3xl text-dark-blue font-bold mt-5">{{ $successRate }}%</strong>
                        <span class="font-16 text-slate-500 font-medium">{{ trans('quiz.success_rate') }}</span>
                    </div>
                </div>
        ...
        <div class="flex align-items-start align-items-md-center justify-between flex-col flex-md-row">
            ...
            <form action="/panel/quizzes/results" method="get" class="">
                <div class="flex items-center flex-row-reverse flex-md-row justify-content-start justify-content-md-center mt-4 mt-md-0">
                    <label class="mb-0 mr-10 cursor-pointer text-sm text-slate-500 font-medium" for="onlyOpenQuizzesSwitch">{{ trans('quiz.show_only_open_results') }}</label>
                                    ...
                                    <tr>
                                        <td class="text-left align-middle">
                                            <div class="user-inline-avatar flex items-center">
                                                ...
                                                <div class=" ml-2">
                                                    <span class="block">{{ $result->user->full_name }}</span>
                                                    <span class="mt-5 text-sm text-slate-500 block">{{ $result->user->email }}</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="text-left align-middle">
                                            <span class="block">{{ $result->quiz->title }}</span>
                                            <span class="text-sm text-slate-500 block">{{ $result->quiz->webinar->title }}</span>
                                        </td>
                                            ...
                                            <div class="btn-group dropdown table-actions table-actions-lg table-actions-lg">
                                                ...
                                                <div class="dropdown-menu font-weight-normal">
                                                    @if($result->status != 'waiting')
                                                        <a href="/panel/quizzes/{{ $result->id }}/result" class="webinar-actions block mt-10">{{ trans('public.view') }}</a>
                                                    @endif

                                                    @if($result->status == 'waiting')
                                                        <a href="/panel/quizzes/{{ $result->id }}/edit-result" class="webinar-actions block mt-10">{{ trans('public.review') }}</a>
                                                    @endif

                                                    <a href="/panel/quizzes/results/{{ $result->id }}/delete" class="webinar-actions block mt-10 delete-action">{{ trans('public.delete') }}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
